 ...
 */
        ...
        $.getJSON('reservationManagement/train_price', function (data) {
            ...
            for (x = 0; x < len; x++) {
                ...
                $("." + x + "").append('<td input type = "button" ><div class="icon-preview"><a href="' + data[x].tid + '" id="priceViewNext" class="btn btn-raised btn-sm"><i class="material-icons" >image</i></a></div></td>');            
